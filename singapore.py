...
st.markdown("<h1 style='text-align: center; color: white;'>Singapore Flat Resale Price Predicton</h1>",unsafe_allow_html=True)

df=pd.read_csv(r"C:\Users\vihari\OneDrive\Desktop\Singapore Flat Resale - DS_Singapore Resale Flat Prices Predicting\final.csv")
...
with tab1:
    ...
    with col2:
        ...
        st.write('* Comparing other regressors, Random Forest Regressor had a high :blue[R-squared score], which means it has performed best. ')
...
with tab3:
    ...
    if st.button('Predict and Conclusion'):
            ...
            def load_data():
                # Load data
                data = pd.read_csv(r"C:\Users\vihari\OneDrive\Desktop\Singapore Flat Resale - DS_Singapore Resale Flat Prices Predicting\final.csv")
